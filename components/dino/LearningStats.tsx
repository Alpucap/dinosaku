...
export default function LearningStats() {
  ...
  return <div className="learning-stats" aria-label="Ringkasan progres">
    ...
    <div onDoubleClick={handleResetEnergy} title="Klik 2x untuk cheat reset energi (Developer)" className="cursor-pointer hover:bg-surface-soft transition-colors rounded-xl p-1 -m-1"><span className="stat-icon"><Zap size={21} /></span><span><strong>{ready ? energy : '...'} / 3</strong><small>Energi hari ini</small></span></div>
  </div>;
}
