...
let shellStr = fs.readFileSync('components/layout/PembimbingShell.tsx', 'utf-8');

const newShellStr = `"use client";
...
fs.writeFileSync('components/layout/PembimbingShell.tsx', newShellStr);
