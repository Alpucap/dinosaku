  ...
  return (
    <div className="learning-page w-full">
      ...
      <div className="grid xl:grid-cols-2 gap-8 w-full">
        {/* KOLOM KIRI: PENUGASAN (MISI) */}
        <div className="flex flex-col gap-6">
          <div className="flex items-center gap-3 pb-2 border-b-2 border-border">
            <div className="bg-brand-primary/10 p-2 rounded-lg text-brand-primary">
              <Target size={24} />
            </div>
            <h2 className="text-xl font-heading font-bold text-primary">Penugasan Cerita (Misi)</h2>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-5 items-start">
            <form action={createAssignment} className="rounded-xl border border-default bg-surface p-5 flex flex-col gap-4 md:col-span-2">
              <h3 className="font-bold text-text-primary text-sm">Buat Misi Baru</h3>
              ...
              <div>
                <label className="block text-[11px] uppercase tracking-wider font-bold text-text-secondary mb-1">Topik Belajar</label>
                <select name="topic" required className="w-full bg-surface-soft border border-border-strong rounded-lg p-2 text-sm focus:border-brand-primary outline-none transition-colors">
              ...
              <div>
                ...
                <select name="theme" required className="w-full bg-surface-soft border border-border-strong rounded-lg p-2 text-sm focus:border-brand-primary outline-none transition-colors">
